...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    title: '"챌린지" 난이도 단계 신설',
    items: [
      '기초/중급/고급 위에 새로운 최상위 난이도 "챌린지"를 추가했어요. 알고리즘(백트래킹·고급 DP·그래프·트라이 등 15문제), 파이썬(데코레이터·클로저·제너레이터·컨텍스트 매니저 등 8문제), SQL(재귀 CTE·상관 서브쿼리·Top-N 등 6문제), JavaScript(클로저·제너레이터·클래스 상속·Promise.all 등 6문제), Java/C(제네릭·스트림·동시성, 함수 포인터·공용체 등 각 12문제)까지 전 언어에 걸쳐 코딩테스트 수준의 챌린지 문제 59개를 새로 추가했어요.',
